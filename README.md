...
The project also includes grammar, lexer, and parser files which implement the conditional compilation process of VBA, and which interact with VBA LIKE expressions.
